...
public abstract class ShaderProgram {
    ...
    public void cleanUp(){
        //Removes shader from program memory
        stop();
    ...
    //Loads differnt types of variables into the memory After the location has been stored
    ...
    private static int loadShader(String file, int type){
        ...
        try{
            ...
            System.out.println("ERROR IS HEAR");
            e.printStackTrace();
            System.exit(-1);
        }
        //Turn the Strings into code
